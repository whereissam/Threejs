...
directionLight.position.set(1,0.25,2)
...
window.requestAnimationFrame(() =>
{
    rectAreaLightHelper.position.copy(rectAreaLight.position)//put to right place
    rectAreaLightHelper.quaternion.copy(rectAreaLight.quaternion)//四元數, to rotate it
